...
- APK весит около 21 МБ вместо пары мегабайт — внутри лежит интерпретатор Python
- только `arm64-v8a`: сборка Python нужной версии есть лишь под эту архитектуру
...
> [!NOTE]
> Раздел описывает направление работы, а не готовую функцию. В опубликованных сборках её пока нет.
